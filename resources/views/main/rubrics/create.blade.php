    ...
    <div class="max-w-5xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-indigo-100 overflow-hidden border border-indigo-50">
            <div class="bg-[#764BA2] p-6 sm:p-8 text-white text-center relative overflow-hidden">
                ...
                <h2 class="text-2xl font-bold relative z-10">Create New Rubric</h2>
                <p class="opacity-80 relative z-10 text-sm">Define your subject name and distribute weighting across
                    criteria.</p>
            </div>

            <form method="POST" action="{{ route('rubrics.store') }}" x-data="rubricHandler()"
                ...
                <div
                    ...
                    <div class="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-3">
                            <span class="text-[11px] font-black text-slate-400 uppercase tracking-[0.2em]">Total
                                Weight</span>
                        ...
                        <div class="flex items-center gap-3 w-full sm:w-auto">
                            <button type="button" @click="addCriteria()"
                                class="flex-1 sm:flex-none px-6 py-3 bg-white text-[#764BA2] border-2 border-[#764BA2]/10 font-bold rounded-2xl hover:bg-indigo-50 transition-all flex items-center justify-center gap-2 shadow-sm text-sm uppercase tracking-widest">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <button type="submit" :disabled="totalWeight !== 100"
                                ...
                                class="flex-1 sm:flex-none px-10 py-3 text-white font-bold rounded-2xl transition-all text-sm uppercase tracking-widest">
                                Save Rubric
                            </button>
                        </div>
                    </div>
